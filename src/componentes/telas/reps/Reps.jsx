...
import { deletePostFirebase, addPostFirebase, updatePostFirebase, getRepsUIDFirebase } from '../../servicos/RepsService';
...
function Reps() {
    ...
    useEffect(() => {
        ...
        if (user?.uid != null) {
            const uid = user?.uid;
            getRepsUIDFirebase(uid, setListaObjetos);
        }
        setCarregando(false);
    }, [user]);
